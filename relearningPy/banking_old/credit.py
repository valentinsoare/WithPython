...
class Credit:
    def __init__(self, credit_amount, period_of_credit, interest_rate):
    ...
    def calculate_needed_info(self):
        ...
        return self.bank_profit.quantize(Decimal('0.00')), self.how_much_per_month.quantize(Decimal('0.00')), self.value_to_be_returned.quantize(Decimal('0.00'))
